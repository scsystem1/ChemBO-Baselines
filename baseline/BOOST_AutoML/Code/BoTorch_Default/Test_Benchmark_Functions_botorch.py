...
def test_benchmark_function(kernels=[KernelType.TBD], acquisitions=[AcquisitionType.TBD], benchmarks=None,
                            n_init_points=10, max_iter=100, trial=10):
    base_dir = str(_PROJECT_DIR / f'results/results_botorch_default_{datetime.now().strftime("%Y%m%d")}_trial{trial}')
