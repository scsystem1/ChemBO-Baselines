...
echo "[PrefBO][OCM] Starting run with budget=${BUDGET}, trials=${TRIALS}, seed_start=${SEED_START}, seed_end=$((SEED_START + TRIALS - 1)), cpu_cap=${CPU_THREAD_CAP}, preferences=${PREFBO_PREFERENCES_FILE}"
